...
- 小程序的主体基本上都是AI生成的. 科技改变生活! 整理好之后会将代码开源.(遥遥无期)
...
而云存储则包含[数据](cloud/data), [图像](cloud/images), [音乐](cloud/music)与[视频](cloud/video):
...
- 数据: 以json存储的各页面数据
  ...
  - [音乐](cloud/data/musicData.json) 音乐播放器数据
  - [主题](cloud/data/themeData.json) 主题配置数据
...
- 视频:
  - [过渡动画](cloud/video) 切换主题时的过渡动画(theme_transition_1-4.mp4)
...
[summarize_danmakus.py](scripts/弹幕总结/summarize_danmakus.py) 是一个用于下载B站视频弹幕并使用AI进行内容总结的脚本。
